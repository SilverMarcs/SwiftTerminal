...
extension NSAttributedString.Key {
    ...
    fileprivate nonisolated static let markdownCodeBlockID = Self("MarkdownCodeBlockID")
    fileprivate nonisolated static let markdownTableBlockID = Self("MarkdownTableBlockID")
    static let markdownThematicBreak = Self("MarkdownThematicBreak")
}
